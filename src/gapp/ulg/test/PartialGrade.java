...
public class PartialGrade {
    ...
    private static boolean gradeTest4(boolean ok) {
        ...
        if (ok) ok = test_OptimalPlayer(1.5f, 150000, "MNKgameFactory 3,4,3", true, 100, true, MNKgameFactory::new, new String[] {"M", "N", "K"}, new Object[] {3, 4, 3});
        return ok;
    }
        ...
        return runTest("Test OptimalPlayer con "+msg, sc, ms, () -> {
            try {
                ...
                if (py == PlayerFactory.Play.TRY_COMPUTE)
                    if (opF.tryCompute(gF, parallel, null) != null) return err("tryCompute fallisce");
