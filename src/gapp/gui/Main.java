...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Font.loadFont(getClass().getResourceAsStream("/resources/Fonts/Comfortaa-Bold.ttf"), 14);
        Font.loadFont(getClass().getResourceAsStream("/resources/Fonts/Comfortaa-Regular.ttf"), 14);
        Font.loadFont(getClass().getResourceAsStream("/resources/Fonts/Chronica/TTF/ChronicaPro-Light.ttf"), 14);
        Font.loadFont(getClass().getResourceAsStream("/resources/Fonts/Comfortaa-Light.ttf"), 14);
        Font.loadFont(getClass().getResourceAsStream("/resources/Fonts/Chronica/TTF/ChronicaPro-Bold.ttf"), 14);
        Font.loadFont(getClass().getResourceAsStream("/resources/Fonts/Chronica/TTF/ChronicaPro-Black.ttf"), 14);

        Font.loadFont(getClass().getResourceAsStream("/resources/Fonts/Junction-bold.otf"), 14);
        Font.loadFont(getClass().getResourceAsStream("/resources/Fonts/Junction-light.otf"), 14);
        Font.loadFont(getClass().getResourceAsStream("/resources/Fonts/Junction-regular.otf"), 14);
    ...
    public Parent chooseGameFactory(){
        ...
        Image settingsImage = new Image(getClass().getClassLoader().getResource("resources/Settings.png").toExternalForm());
