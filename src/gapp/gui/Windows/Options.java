...
public class Options {
    ...
    public Parent getWindow(){
        ...
        Image arrow = new Image(getClass().getClassLoader().getResource("resources/Arrow30.png").toExternalForm());
        ...
        Image closeIcon = new Image(getClass().getClassLoader().getResource("resources/Close25.png").toExternalForm());
